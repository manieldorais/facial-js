...
cd [pasta_do_projeto]
Adicione a Imagem de Referência: Você deve adicionar um arquivo de imagem chamado exatamente referencia.jpg (ou .png) na raiz do projeto, contendo a face que você deseja reconhecer/verificar.

Inicie o Servidor Local (Exemplo com Node/NPM):
